          ...
          <div className="relative flex items-center justify-center w-full lg:w-auto">
            <div className="relative w-full max-w-md sm:max-w-lg md:max-w-md lg:max-w-lg xl:max-w-xl">
              ...
              >
                ...
                {/* Conditionally wrap with Link if product is assigned */}
                {currentSlideData.product_id ? (
                  <Link href={`/product/${currentSlideData.product_id}`} className="block w-full h-full">
                    <Image
                      ...
                      width={600}
                      height={400}
                      className="object-contain drop-shadow-2xl max-h-full w-full h-full cursor-pointer hover:scale-105 transition-transform duration-300"
                      priority
                    />
                  </Link>
                ) : (
